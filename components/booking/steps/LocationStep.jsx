...
//         </div>
//         <h3 className="text-2xl font-bold text-white mb-2">Enable Location</h3>
//         <p className="text-gray-400 mb-6">
//           Allow access to your location so we can find nearby barbershops
//         </p>
//       </div>
...
//         disabled={loading}
//         className="w-full py-3 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-black font-semibold rounded-lg transition text-base"
//       >
//         {loading ? "Getting Location..." : "Enable Location Access"}
//       </Button>

//       <p className="text-center text-gray-400 text-sm">
//         Your location will only be used to find nearby barbershops
//       </p>
//     </div>
//   );
// }