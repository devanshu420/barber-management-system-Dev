...
// import { useRouter } from "next/navigation";
// import { Button } from "@/components/ui/button";
// import { CheckCircle, Calendar, Clock, User, Scissors, MapPin, DollarSign, AlertCircle } from "lucide-react";
...
//     // Prepare request payload based on your backend expected fields
//     const payload = {
//       shopId: bookingData.shop.id,
//       serviceId: bookingData.service?.id,
//       serviceName: bookingData.service?.name,
//       bookingDate: bookingData.date,
//       bookingTime: bookingData.time, // make sure this matches {startTime, endTime}
//       amount: bookingData.service?.price,
//       paymentMethod: "razorpay", // or whatever you use
//       notes: bookingData.notes || "",
//     };
//       console.log("Booking payload:", payload);

//     const response = await axios.post("http://localhost:5000/api/bookings/create-bookings", payload, {
//       headers: {
//         Authorization: `Bearer ${token}`,
//         "Content-Type": "application/json",
//       },
