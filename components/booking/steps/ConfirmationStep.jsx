  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-black via-gray-900 to-black flex items-center justify-center p-6">
      <motion.div
        ...
        className="w-full max-w-2xl bg-gray-900/60 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 shadow-2xl"
      >
        {/* Header */}
        ...
        <div className="space-y-4 bg-gray-800/40 p-6 rounded-xl border border-gray-700">
          <div className="flex items-center gap-3 text-gray-300">
            ...
            <span>{bookingData.shop?.name}</span>
          </div>
          ...
          <div className="pt-4 border-t border-gray-700 text-xl font-semibold text-white">
        ...
        {/* Message */}
        {message && (
          <div className="mt-6 text-center text-sm font-medium text-red-400">
            {message}
          </div>
        )}
        ...
        <div className="flex gap-4 mt-8">
          <button
            onClick={onBack}
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg border border-gray-700 text-gray-300 hover:bg-gray-800 transition"
          >
            <ArrowLeft size={18} />
            Back
          </button>
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg bg-cyan-500 hover:bg-cyan-600 text-black font-semibold transition disabled:opacity-60"
          >
            {loading ? (
              <>
