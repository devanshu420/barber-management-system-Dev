...
export function ServiceSelection({ onSelect, shop }) {
  ...
  // Totals (price + optional duration) using reduce
  ...
  // Continue – send full structure to parent
    ...
    <div className="space-y-7 sm:space-y-8">
      ...
      >
        ...
        <p className="text-gray-400 text-xs sm:text-sm max-w-md mx-auto">
          {shop?.name ? (
            <>
              Choose one or more services at{" "}
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between text-[11px] sm:text-xs text-gray-400">
                  <span>
                    {selected
                      ? "Tap again to remove this service"
                      : "Tap to add this service"}
                  </span>
      ...
      {selectedServices.length > 0 && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="p-4 sm:p-5 bg-emerald-500/10 border border-emerald-500/35 rounded-2xl space-y-3"
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-white font-semibold text-xs sm:text-sm mt-1 space-y-0.5">
