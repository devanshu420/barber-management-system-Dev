  ...
  if (bookingConfirmed) {
    return (
      <div className="text-center space-y-6">
        ...
        <p className="text-gray-500">Your appointment has been successfully booked and paid for.</p>
        <Button asChild>
  ...
  if (showPayment) {
    return (
      <div className="space-y-6">
        ...
        <p className="text-gray-500">Secure payment to confirm your booking</p>
        <PaymentForm
          ...
          {bookingData.barber && (
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">★ {bookingData.barber.rating} rating</p>
              </div>
            </div>
          )}
