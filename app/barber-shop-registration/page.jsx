...
//   //     // Location fields as backend validator expects
//   //     submitFormData.append("location.address", formData.address);
//   //     submitFormData.append("location.city", formData.city);
//   //     submitFormData.append("location.state", formData.state);
//   //     submitFormData.append("location.zipCode", formData.zipCode || "");

//   //     const lat = parseFloat(formData.latitude);
//   //     const lng = parseFloat(formData.longitude);

//   //     if (!isNaN(lat) && !isNaN(lng)) {
//   //       submitFormData.append("location.latitude", String(lat));
//   //       submitFormData.append("location.longitude", String(lng));
//   //     }
...
//     // 🔥 Build location object EXACTLY like your working Postman body
//     const lat = parseFloat(formData.latitude);
//     const lng = parseFloat(formData.longitude);
...
//     // 🔑 Backend expects full "location" object, not split fields
//     submitFormData.append("location", JSON.stringify(locationPayload));
