...
//       // ✅ Add barberOwner from localStorage token (ensure you store userId)
//       const userId = localStorage.getItem("userId"); 
//       submitFormData.append("barberOwner", userId || "");

//       // Images
//       formData.images.forEach((image) => submitFormData.append("images", image));
...
//       // Working hours
//       submitFormData.append("workingHours", JSON.stringify(formData.workingHours));
...
//           {/* ============================================ */}
//           {/* IMAGE UPLOAD SECTION - NEW FEATURE */}
//           {/* ============================================ */}
//           <section className="bg-gray-900/50 backdrop-blur-md border border-gray-800 rounded-2xl p-6 sm:p-8 shadow-lg">
//             <h2 className="text-2xl font-bold text-white mb-6 flex items-center space-x-2">
//               <ImageIcon className="w-6 h-6 text-teal-400" />
...
//                   className="w-full bg-teal-500/20 text-teal-300 hover:bg-teal-500/30 border-2 border-dashed border-teal-500/50 rounded-lg px-4 py-6 flex items-center justify-center space-x-2 transition"
//                 >
//                   <ImageIcon className="w-5 h-5" />
...
//                 <p className="text-gray-400 text-xs mt-2">
//                   ℹ️ Supported formats: JPG, PNG, WebP | Max 5MB per image
//                 </p>
//               </div>
...
//                         className="absolute top-1 right-1 bg-red-500/90 hover:bg-red-600 rounded-full p-1 opacity-0 group-hover:opacity-100 transition"
//                       >
...
//           {/* ============================================ */}
//           {/* LOCATION INFORMATION WITH AUTO FETCH */}
//           {/* ============================================ */}
//           <section className="bg-gray-900/50 backdrop-blur-md border border-gray-800 rounded-2xl p-6 sm:p-8 shadow-lg">
//             <h2 className="text-2xl font-bold text-white mb-6 flex items-center space-x-2">
//               <MapPin className="w-6 h-6 text-teal-400" />
...
//               {/* Coordinates with Auto Fetch Button */}
//               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                 <div>
//                   <Label className="text-white font-semibold mb-2 block">
//                     Latitude
...
//                   />
//                   <p className="text-gray-400 text-xs mt-1">
//                     ℹ️ Decimal format (e.g., 22.123456)
//                   </p>
//                 </div>
//                 <div>
//                   <Label className="text-white font-semibold mb-2 block">
...
//                   />
//                   <p className="text-gray-400 text-xs mt-1">
//                     ℹ️ Decimal format (e.g., 75.123456)
//                   </p>
//                 </div>
//               </div>

//               {/* AUTOMATIC COORDINATES FETCH BUTTON - NEW FEATURE */}
//               <div className="flex gap-2">
//                 <Button
//                   type="button"
//                   onClick={handleFetchCoordinates}
...
//               <p className="text-gray-400 text-xs bg-gray-800/30 p-3 rounded-lg">
//                 📍 <strong>Note:</strong> You can either manually enter coordinates or use the
//                 "Auto-Fetch Coordinates" button to automatically detect your location using GPS.
//               </p>
//             </div>
//           </section>
...
// //   // ============================================
// //   // IMAGE UPLOAD HANDLERS - NEW FEATURE
// //   // ============================================

// //   /**
// //    * Handle multiple image selection
// //    * Validates file type and creates previews
// //    */
// //   const handleImageSelect = (e) => {
// //     const files = Array.from(e.target.files || []);
...
// //         return false;
// //       }
// //       // Optional: Check file size (max 5MB per image)
// //       if (file.size > 5 * 1024 * 1024) {
// //         setError(`${file.name} is too large (max 5MB)`);
// //         return false;
// //       }
...
// //   // ============================================
// //   // AUTOMATIC COORDINATES FETCH - NEW FEATURE
// //   // ============================================
