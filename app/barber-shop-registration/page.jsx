...
//       await axios.post("/api/barber/register", payload);
...
//             <Building2 className="w-8 h-8 text-teal-400" />
//           </div>
//           <h1 className="text-4xl sm:text-5xl font-bold text-white mb-3">Register Your Barbershop</h1>
//           <p className="text-gray-400 text-lg">Set up your business profile and start accepting bookings</p>
//         </div>
...
//                       className="rounded border-gray-600 text-teal-500"
//                     />
//                     <span className="text-white font-semibold capitalize w-20">{day}</span>
//                   </label>
//                   {formData.workingHours[day].isOpen && (
//                     <div className="flex items-center space-x-2 flex-1">
//                       <Input
