...
const Button = forwardRef(
  (
    ...
    const variants = {
      ...
      secondary:
        "bg-gray-800/60 border border-cyan-400/20 text-white hover:bg-gray-700/60 transition",
    };
...
export default function PaymentPage() {
  ...
  const applyPromo = () => {
    ...
    if (promoCode.toUpperCase() === "SAVE20") {
      const discountAmount = Math.floor(bookingData.basePrice * 0.2);
      setDiscount(discountAmount);
    } else if (promoCode.toUpperCase() === "SAVE50") {
      const discountAmount = Math.floor(bookingData.basePrice * 0.5);
      setDiscount(discountAmount);
    } else {
      setDiscount(0);
  ...
  const handlePayment = async () => {
    if (selectedPayment === "upi") {
      ...
      setError("This payment method is not yet available");
    }
  };
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          ...
          <p className="text-gray-400">
            Complete your booking at {bookingData.salonName}
          </p>
        </motion.div>
            ...
            >
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-400 mb-3">{bookingData.salonName}</p>
            ...
            >
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-gray-800/60 border border-gray-700 text-white rounded-xl placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition uppercase"
                />
              ...
              <p className="text-gray-500 text-xs mt-2">
                💡 Try: SAVE20 (20% off) or SAVE50 (50% off)
              </p>
            </motion.div>
          </div>
